...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-background-secondary border-r border-white/5 h-screen flex flex-col sticky top-0">
      {/* Brand */}
      <div className="h-20 flex items-center px-6 border-b border-white/5">
        <Link href="/" className="flex items-center">
          <div className="w-8 h-8 rounded bg-brand-primary/10 flex items-center justify-center mr-3 border border-brand-primary/20 hover:bg-brand-primary/20 transition-colors">
            <span className="font-heading font-bold text-brand-primary text-sm">B</span>
          </div>
          <span className="font-heading text-sm tracking-widest text-white uppercase font-semibold hover:text-brand-primary transition-colors">
            ADMIN PANEL
          </span>
        </Link>
      </div>
