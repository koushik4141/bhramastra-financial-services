    ...
    <div className="flex min-h-screen bg-[#050505] text-white">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-20 border-b border-white/5 bg-[#050505]/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10">
          <div className="flex items-center bg-white/5 rounded-lg px-4 py-2 w-96 border border-white/10 focus-within:border-brand-green/50 transition-colors">
          ...
          <div className="flex items-center gap-6">
            <button className="relative text-brand-grey hover:text-white transition-colors">
              <Bell size={20} />
              <span className="absolute -top-1 -right-1 w-2 h-2 rounded-full bg-brand-green"></span>
            </button>
            <div className="flex items-center gap-3 border-l border-white/10 pl-6">
              <div className="w-8 h-8 rounded-full bg-brand-gold/20 flex items-center justify-center text-brand-gold font-heading text-sm border border-brand-gold/30">
                A
              </div>
